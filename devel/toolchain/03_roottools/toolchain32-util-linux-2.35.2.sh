...
if test -d $LFS/sources/util-linux-2.35.2
 then
  rm -rf $LFS/sources/util-linux-2.35.2
fi
tar -xJf $LFS/sources/util-linux-2.35.2.tar.xz -C $LFS/sources/ &&
cd $LFS/sources/util-linux-2.35.2 &&
