...
${log} `basename "$0"` " ======================================" basic &&
./basic36_expat-2.4.1.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic37_inetutils-2.0.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic38_perl-5.34.0.sh &&
${log} `basename "$0"` " ======================================" basic &&
...
./basic43_kmod-29.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic44_libelf-0.185.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic45_libffi-3.3.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic46_openssl-1.1.1k.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic47_python-3.9.5.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic48_ninja-1.10.2.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic49-meson-0.58.1.sh &&
${log} `basename "$0"` " ======================================" basic &&
...
${log} `basename "$0"` " ======================================" basic &&
./basic54_findutils-4.8.0.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic55_groff-1.22.4.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic56_grub-2.06.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic57_less-581.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic58_gzip-1.10.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic59_iproute2-5.12.0.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic60_kbd-2.4.0.sh &&
${log} `basename "$0"` " ======================================" basic &&
...
${log} `basename "$0"` " ======================================" basic &&
./basic67_vim-8.2.3001.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic68_systemd-248.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic69_dbus-1.12.20.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic70_procps-ng-3.3.17.sh &&
${log} `basename "$0"` " ======================================" basic &&
./basic71_util-linux-2.37.sh &&
${log} `basename "$0"` " ======================================" basic &&
